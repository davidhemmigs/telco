...
import TelecomSymbol from '../../assets/svg/LOGO-TELECOM.svg'
...
TelecomSymbol.viewBox = TelecomSymbol.viewBox || '0 0 800 127'
...
// For non-square SVGs, we can use the symbol data from the import to set the
// proper viewBox attribute on the Icon wrapper.
export const TelecomIcon = icon('LOGO-TELECOM', {viewBox: TelecomSymbol.viewBox})
